...
@Entity
@Table(name = "erp_customer_attached_invoices")
@Data
public class CustomerAttachedInvoices implements Serializable {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private Long attachedInvoicesId;

	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name="customer_attached_invoices_id")
	...
	@ManyToMany
	@JoinColumn(name="customer_attached_invoices_id", nullable=true)
