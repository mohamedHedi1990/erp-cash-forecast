...
public class EncaissementController {
	...
	@Autowired
	private EncaissementService encaissementDecaissementService;
	...
	public List<Encaissement> findAllEncaissementsBetweenTwoDates(
	...
	public Encaissement saveNewEncaissement(@RequestBody Encaissement encDec) {
		return encaissementDecaissementService.saveNewEncaissement(encDec);
	}
